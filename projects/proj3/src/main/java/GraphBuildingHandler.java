...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private ArrayList<Long> possibleConn;
...
//            System.out.println("Node's name: " + attributes.getValue("v"));
            GraphDB.cleanString(attributes.getValue("v"));
        }
    }
...
//            System.out.println("Finishing a way...");
            if (flag) {
                for (int i = 0; i < possibleConn.size() - 1; i++) {
                    g.addEdge(possibleConn.get(i), possibleConn.get(i + 1));
                }
            }
            flag = false;
            possibleConn = new ArrayList<>();
